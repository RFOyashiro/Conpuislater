...
void initialise_suivants(void) {
	...
	// LP
	suivants[_declarationFonction_][ENTIER] = 1;
	suivants[_declarationFonction_][ID_FCT] = 1;
	suivants[_declarationFonction_][FIN] = 1;
	...
	suivants[_expression_][OU] = 1;
	suivants[_expression_][VIRGULE] = 1;
	
	suivants[_expression_][ID_VAR] = 1;
	suivants[_expression_][ACCOLADE_OUVRANTE] = 1;
	suivants[_expression_][SI] = 1;
	suivants[_expression_][TANTQUE] = 1;
	suivants[_expression_][ID_FCT] = 1;
	suivants[_expression_][RETOUR] = 1;
	suivants[_expression_][ECRIRE] = 1;
	suivants[_expression_][ACCOLADE_FERMANTE] = 1;
	...
	suivants[_expressionBis_][OU] = 1;
	suivants[_expressionBis_][VIRGULE] = 1;
	
	suivants[_expressionBis_][ID_VAR] = 1;
	suivants[_expressionBis_][ACCOLADE_OUVRANTE] = 1;
	suivants[_expressionBis_][SI] = 1;
	suivants[_expressionBis_][TANTQUE] = 1;
	suivants[_expressionBis_][ID_FCT] = 1;
	suivants[_expressionBis_][RETOUR] = 1;
	suivants[_expressionBis_][ECRIRE] = 1;
	suivants[_expressionBis_][ACCOLADE_FERMANTE] = 1;
	...
	suivants[_conjonction_][ID_VAR] = 1;
	suivants[_conjonction_][ACCOLADE_OUVRANTE] = 1;
	suivants[_conjonction_][SI] = 1;
	suivants[_conjonction_][TANTQUE] = 1;
	suivants[_conjonction_][ID_FCT] = 1;
	suivants[_conjonction_][RETOUR] = 1;
	suivants[_conjonction_][ECRIRE] = 1;
	suivants[_conjonction_][ACCOLADE_FERMANTE] = 1;
	...
	suivants[_conjonctionBis_][ID_VAR] = 1;
	suivants[_conjonctionBis_][ACCOLADE_OUVRANTE] = 1;
	suivants[_conjonctionBis_][SI] = 1;
	suivants[_conjonctionBis_][TANTQUE] = 1;
	suivants[_conjonctionBis_][ID_FCT] = 1;
	suivants[_conjonctionBis_][RETOUR] = 1;
	suivants[_conjonctionBis_][ECRIRE] = 1;
	suivants[_conjonctionBis_][ACCOLADE_FERMANTE] = 1;
	...
	suivants[_comparaison_][ID_VAR] = 1;
	suivants[_comparaison_][ACCOLADE_OUVRANTE] = 1;
	suivants[_comparaison_][SI] = 1;
	suivants[_comparaison_][TANTQUE] = 1;
	suivants[_comparaison_][ID_FCT] = 1;
	suivants[_comparaison_][RETOUR] = 1;
	suivants[_comparaison_][ECRIRE] = 1;
	suivants[_comparaison_][ACCOLADE_FERMANTE] = 1;
	...
	suivants[_comparaisonBis_][ID_VAR] = 1;
	suivants[_comparaisonBis_][ACCOLADE_OUVRANTE] = 1;
	suivants[_comparaisonBis_][SI] = 1;
	suivants[_comparaisonBis_][TANTQUE] = 1;
	suivants[_comparaisonBis_][ID_FCT] = 1;
	suivants[_comparaisonBis_][RETOUR] = 1;
	suivants[_comparaisonBis_][ECRIRE] = 1;
	suivants[_comparaisonBis_][ACCOLADE_FERMANTE] = 1;
	
	//M
	suivants[_modulo_][INFERIEUR] = 1;
	suivants[_modulo_][EGAL] = 1;
	suivants[_modulo_][ET] = 1;
	suivants[_modulo_][POINT_VIRGULE] = 1;
	suivants[_modulo_][ALORS] = 1;
	suivants[_modulo_][FAIRE] = 1;
	suivants[_modulo_][PARENTHESE_FERMANTE] = 1;
	suivants[_modulo_][CROCHET_FERMANT] = 1;
	suivants[_modulo_][OU] = 1;
	suivants[_modulo_][VIRGULE] = 1;
	
	suivants[_modulo_][ID_VAR] = 1;
	suivants[_modulo_][ACCOLADE_OUVRANTE] = 1;
	suivants[_modulo_][SI] = 1;
	suivants[_modulo_][TANTQUE] = 1;
	suivants[_modulo_][ID_FCT] = 1;
	suivants[_modulo_][RETOUR] = 1;
	suivants[_modulo_][ECRIRE] = 1;
	suivants[_modulo_][ACCOLADE_FERMANTE] = 1;
	
	//MB
	suivants[_moduloBis_][INFERIEUR] = 1;
	suivants[_moduloBis_][EGAL] = 1;
	suivants[_moduloBis_][ET] = 1;
	suivants[_moduloBis_][POINT_VIRGULE] = 1;
	suivants[_moduloBis_][ALORS] = 1;
	suivants[_moduloBis_][FAIRE] = 1;
	suivants[_moduloBis_][PARENTHESE_FERMANTE] = 1;
	suivants[_moduloBis_][CROCHET_FERMANT] = 1;
	suivants[_moduloBis_][OU] = 1;
	suivants[_moduloBis_][VIRGULE] = 1;
	
	suivants[_moduloBis_][ID_VAR] = 1;
	suivants[_moduloBis_][ACCOLADE_OUVRANTE] = 1;
	suivants[_moduloBis_][SI] = 1;
	suivants[_moduloBis_][TANTQUE] = 1;
	suivants[_moduloBis_][ID_FCT] = 1;
	suivants[_moduloBis_][RETOUR] = 1;
	suivants[_moduloBis_][ECRIRE] = 1;
	suivants[_moduloBis_][ACCOLADE_FERMANTE] = 1;
	...
	suivants[_expArith_][ID_VAR] = 1;
	suivants[_expArith_][ACCOLADE_OUVRANTE] = 1;
	suivants[_expArith_][SI] = 1;
	suivants[_expArith_][TANTQUE] = 1;
	suivants[_expArith_][ID_FCT] = 1;
	suivants[_expArith_][RETOUR] = 1;
	suivants[_expArith_][ECRIRE] = 1;
	suivants[_expArith_][ACCOLADE_FERMANTE] = 1;
	
	// EB
	suivants[_expArithBis_][INFERIEUR] = 1;
	suivants[_expArithBis_][EGAL] = 1;
	suivants[_expArithBis_][MODULO] = 1;
	...
	suivants[_expArithBis_][ID_VAR] = 1;
	suivants[_expArithBis_][ACCOLADE_OUVRANTE] = 1;
	suivants[_expArithBis_][SI] = 1;
	suivants[_expArithBis_][TANTQUE] = 1;
	suivants[_expArithBis_][ID_FCT] = 1;
	suivants[_expArithBis_][RETOUR] = 1;
	suivants[_expArithBis_][ECRIRE] = 1;
	suivants[_expArithBis_][ACCOLADE_FERMANTE] = 1;
	
	// T
	suivants[_terme_][PLUS] = 1;
	suivants[_terme_][MOINS] = 1;
	suivants[_terme_][MODULO] = 1;
	...
	suivants[_terme_][ID_VAR] = 1;
	suivants[_terme_][ACCOLADE_OUVRANTE] = 1;
	suivants[_terme_][SI] = 1;
	suivants[_terme_][TANTQUE] = 1;
	suivants[_terme_][ID_FCT] = 1;
	suivants[_terme_][RETOUR] = 1;
	suivants[_terme_][ECRIRE] = 1;
	suivants[_terme_][ACCOLADE_FERMANTE] = 1;
	
	// TB
	suivants[_termeBis_][PLUS] = 1;
	suivants[_termeBis_][MOINS] = 1;
	suivants[_termeBis_][MODULO] = 1;
	...
	suivants[_termeBis_][ID_VAR] = 1;
	suivants[_termeBis_][ACCOLADE_OUVRANTE] = 1;
	suivants[_termeBis_][SI] = 1;
	suivants[_termeBis_][TANTQUE] = 1;
	suivants[_termeBis_][ID_FCT] = 1;
	suivants[_termeBis_][RETOUR] = 1;
	suivants[_termeBis_][ECRIRE] = 1;
	suivants[_termeBis_][ACCOLADE_FERMANTE] = 1;
	...
	suivants[_negation_][ID_VAR] = 1;
	suivants[_negation_][ACCOLADE_OUVRANTE] = 1;
	suivants[_negation_][SI] = 1;
	suivants[_negation_][TANTQUE] = 1;
	suivants[_negation_][ID_FCT] = 1;
	suivants[_negation_][RETOUR] = 1;
	suivants[_negation_][ECRIRE] = 1;
	suivants[_negation_][ACCOLADE_FERMANTE] = 1;
	...
	suivants[_facteur_][ID_VAR] = 1;
	suivants[_facteur_][ACCOLADE_OUVRANTE] = 1;
	suivants[_facteur_][SI] = 1;
	suivants[_facteur_][TANTQUE] = 1;
	suivants[_facteur_][ID_FCT] = 1;
	suivants[_facteur_][RETOUR] = 1;
	suivants[_facteur_][ECRIRE] = 1;
	suivants[_facteur_][ACCOLADE_FERMANTE] = 1;
	...
	suivants[_var_][ID_VAR] = 1;
	suivants[_var_][ACCOLADE_OUVRANTE] = 1;
	suivants[_var_][SI] = 1;
	suivants[_var_][TANTQUE] = 1;
	suivants[_var_][ID_FCT] = 1;
	suivants[_var_][RETOUR] = 1;
	suivants[_var_][ECRIRE] = 1;
	suivants[_var_][ACCOLADE_FERMANTE] = 1;
	...
	suivants[_optIndice_][ID_VAR] = 1;
	suivants[_optIndice_][ACCOLADE_OUVRANTE] = 1;
	suivants[_optIndice_][SI] = 1;
	suivants[_optIndice_][TANTQUE] = 1;
	suivants[_optIndice_][ID_FCT] = 1;
	suivants[_optIndice_][RETOUR] = 1;
	suivants[_optIndice_][ECRIRE] = 1;
	suivants[_optIndice_][ACCOLADE_FERMANTE] = 1;
	...
	suivants[_appelFct_][ID_VAR] = 1;
	suivants[_appelFct_][ACCOLADE_OUVRANTE] = 1;
	suivants[_appelFct_][SI] = 1;
	suivants[_appelFct_][TANTQUE] = 1;
	suivants[_appelFct_][ID_FCT] = 1;
	suivants[_appelFct_][RETOUR] = 1;
	suivants[_appelFct_][ECRIRE] = 1;
	suivants[_appelFct_][ACCOLADE_FERMANTE] = 1;
